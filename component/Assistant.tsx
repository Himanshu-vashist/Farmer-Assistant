...
import { FaMicrophone, FaSync, FaBolt } from "react-icons/fa";
...
const Assistant: React.FC = () => {
    ...
    const handleGenerateResponse = async (): Promise<void> => {
        ...
        try {
            ...
            setHistory((prevHistory) => [...prevHistory, { question: userInput, answer: formattedResponse }]);
        } catch (error) {
            ...
            <div className="assistant-container">
                ...
                <div className="response-container">
                    <div className="formatted-response">
                        {response ? (
                            response.split("\n").map((line, i) => (
                                <p key={i} className="response-line">{line}</p>
                            ))
                        ) : (
