...
interface AgriTradeContextType {
...
export const AgriTradeContext = createContext<AgriTradeContextType>({
  connectWallet: async () => {},
  account: null,
  contract: null,
  provider: null,
...
interface AgriTradeProviderProps {
  children: React.ReactNode;
}

export const AgriTradeProvider: React.FC<AgriTradeProviderProps> = ({ children }) => {
